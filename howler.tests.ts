...
var label = document.getElementById('label') as HTMLElement;
...
var tests = [
  ...
  function(fn: any) {
    ...
    sound1.once('fade', function() {
      if ((sound1 as any)._onfade.length === 0) {
        fn();
      }
    });
  },
...
if (Howler.usingWebAudio) {
  ...
  window.location.href = 'core.html5audio.html';
}
